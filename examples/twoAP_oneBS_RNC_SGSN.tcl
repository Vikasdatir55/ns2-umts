...
$UE0 attach-agent $udp(0) $WLAN_UE0                   ;# new command: the interface is used for sending
set null(0) [new Agent/Null]
$ns attach-agent $CN_host0 $null(0)
$UE0 connect-agent $udp(0) $null(0) $WLAN_UE0
...
$UE1 attach-agent $udp(1) $WLAN_UE1                   ;# new command: the interface is used for sending
