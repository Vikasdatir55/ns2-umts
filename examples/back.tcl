...
$ns at 10.0 "getCurrentDelay  $ue(0) $wlan_ue(1) \"cbr\" $realtime_monitor"
$ns at  2.3 "getMeanDelay  $ue(0) $wlan_ue(1) \"cbr\" $realtime_monitor "
$ns at 12.3 "getMeanDelay  $ue(0) $wlan_ue(1) \"cbr\" $realtime_monitor "
$ns at 12.0 "getMeanDelay  $ue(0) $wlan_ue(1) \"cbr\" $realtime_monitor"
