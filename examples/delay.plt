...
set ylabel 'Delay(MB)' font "Times-Roman,25"
...
plot [9000:13000] [0:500] 'delay.dat' every 60 using 1:2 ls 1 smooth sbezier with linespoints,'delay.dat' every 60 using 1:3 ls 3 smooth sbezier with linespoints
